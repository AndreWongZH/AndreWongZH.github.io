...
layout: project
type: project
image: images/smartbrains/smartbrains_square.png
...
labels:
  ...
  - Postgresql
  - Express.js
summary: A responsive web application for identifying faces in photographs
---

<img class="ui medium right floated rounded image" src="../images/smartbrains/smartbrains.png">
<img class="ui medium right floated rounded image" src="../images/smartbrains/smartbrains2.png">

Try the application out [here](https://andrewongzh.github.io/FaceRecognition_frontend/).
